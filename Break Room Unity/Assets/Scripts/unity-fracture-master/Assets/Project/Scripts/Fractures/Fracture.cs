...
namespace Project.Scripts.Fractures
{
    ...
    {
        public static ChunkGraphManager FractureGameObject(GameObject gameObject, int seed, int totalChunks, Material insideMaterial, Material outsideMaterial, float jointBreakForce, float density)//Anchor anchor, after gameobject
        {
